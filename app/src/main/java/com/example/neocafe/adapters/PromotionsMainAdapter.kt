...
class PromotionsMainAdapter(private var promotions: List<Promotion>) :
    RecyclerView.Adapter<PromotionsMainAdapter.ArticleViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ArticleViewHolder {
        val binding = CardPromotionsItemsBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class ArticleViewHolder(private val binding: CardPromotionsItemsBinding) :
