...
class SetupPromocodeDialog : DialogFragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.dialog_promocode, container, false)

        val etBonusCode = view.findViewById<EditText>(R.id.et_promocode)
        val btnConfirm = view.findViewById<Button>(R.id.btn_confirm_promocode)
        val btnCancel = view.findViewById<TextView>(R.id.btn_cancel_promocode)
